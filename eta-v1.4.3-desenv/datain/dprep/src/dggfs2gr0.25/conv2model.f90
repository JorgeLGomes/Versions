...
!Soil Temperature layer 2
      read(12)((slp(i,j,7),i=1,nx),j=1,ny) 
!Soil Moisture	layer 2
      read(12)((slp(i,j,8),i=1,nx),j=1,ny) 
!Soil Temperature layer 3
      read(12)((slp(i,j,9),i=1,nx),j=1,ny) 
!Soil Moisture layer 3
      read(12)((slp(i,j,10),i=1,nx),j=1,ny) 
