...
!
      ...
      nrec=1
      do l=1,nz   
       read(12,rec=nrec)((ht(i,j,l),i=1,nx),j=ny,1,-1) 
       nrec=nrec+1
      enddo
      ht=ht/9.8
      do l=1,nz
       read(12,rec=nrec)((rh(i,j,l),i=1,nx),j=ny,1,-1) 
       nrec=nrec+1
      enddo
      do l=1,nz
       read(12,rec=nrec)((q(i,j,l),i=1,nx),j=ny,1,-1) 
       nrec=nrec+1
      enddo
      do l=1,nz
       read(12,rec=nrec)((tp(i,j,l),i=1,nx),j=ny,1,-1) 
       nrec=nrec+1
      enddo
      do l=1,nz
       read(12,rec=nrec)((uw(i,j,l),i=1,nx),j=ny,1,-1) 
       nrec=nrec+1
      enddo
      do l=1,nz
       read(12,rec=nrec)((vw(i,j,l),i=1,nx),j=ny,1,-1) 
       nrec=nrec+1
      enddo
!
!Cont/Sea Mask     
      read(12,rec=nrec)((slp(i,j,1),i=1,nx),j=ny,1,-1) 
      nrec=nrec+1
!Mean Sea Level pressure    
      read(12,rec=nrec)((slp(i,j,2),i=1,nx),j=ny,1,-1) 
      nrec=nrec+1
!Surface Pressure     
      read(12,rec=nrec)((slp(i,j,3),i=1,nx),j=ny,1,-1) 
      nrec=nrec+1
!Topography
      read(12,rec=nrec)((slp(i,j,4),i=1,nx),j=ny,1,-1) 
      nrec=nrec+1
