...
CGSM      PARAMETER  (IMA=129600,JMA=64800,IMJMA=IMA*JMA)
      INTEGER ,PARAMETER  :: IMA=129600
      INTEGER ,PARAMETER  :: JMA=64800
      PARAMETER  (NTYP=14)
      PARAMETER
...
C
       ...
       NNOB=1
c
       dxy=0.00277777777   !resolucao do mapa de veg. 
c
        n=0
        doout210: do nj=1,jma
            alat = -90.000000000014 + (nj-1)*dxy
          doin210:  do  ni=1,ima
              alon = -180.04 + (ni-1)*dxy
              n=n+1
C
            read(20,6122)NTY
 6122       format(i2)
