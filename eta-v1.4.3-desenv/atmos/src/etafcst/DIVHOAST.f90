...
!
                ELSE
!
                    WRITE(6,*) 'BAD FIM ', MYPE,I, J, K, LMH(I,J),FIM(I,J), FILO(I,J), DFI
...
!            
                DFI       = (Q(I,J,K) * 0.608 + 1.) * T(I,J,K) * R * (ALP1PL-ALP1P) / DWDT(I,J,K)
...
!            
                IF (K < LM) THEN 
                   IF (HTM(I,J,K+1) * HBM2(I,J) > 0) THEN
!--------------------------------------------------------------------------------------------------
...
!--------------------------------------------------------------------------------------------------
                IF (K < LM ) THEN
                IF (K == LMV(I+IHE(J),J) .AND. ISLD(I+IHE(J),J) > 0) THEN
!
