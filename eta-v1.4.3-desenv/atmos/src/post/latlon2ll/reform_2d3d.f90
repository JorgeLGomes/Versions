...
!
	...
	elseif (field.eq.'ACM BSFL-GDWR RNOFF ') then; rnofsg=grib/1000
...
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((zs(i,j),i=iw,ie),j=js,jn)
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((lsmk(i,j),i=iw,ie),j=js,jn)
       irec=irec+1
...
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((qs(i,j),i=iw,ie),j=js,jn)
       irec=irec+1
...
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((zorl(i,j),i=iw,ie),j=js,jn)
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((potevap(i,j),i=iw,ie),j=js,jn)
       irec=irec+1
...
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((cld(i,j),i=iw,ie),j=js,jn)
       irec=irec+1
...
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((alb(i,j),i=iw,ie),j=js,jn)
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((cape(i,j),i=iw,ie),j=js,jn)
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((cine(i,j),i=iw,ie),j=js,jn)
!GSM       irec=irec+1
!GSM       write(53,rec=irec)((li(i,j),i=iw,ie),j=js,jn)
       irec=irec+1
