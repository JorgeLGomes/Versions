...
c
cJLG      real*4 coac,codamp,tddamp,dfc,ddfc
      real*4 codamp,tddamp,dfc,ddfc
      ...
      write(6,*) 'const believes there are ', nsoil, ' soil layers'
       ...
       if (lcoac) then
         ...
         IF (DPHD.LT.0.108) THEN
           coac=(0.04+0.08*(0.108-DPHD)/0.099)*(.53846154/DPHD)
         ENDIF
         write(6,*) 'computed coac based on grid resolution...'
      endif
      write(6,*) 'will use coac, dfc, ddfc, tddamp= '
     +            ,coac, dfc, ddfc,tddamp
Cmp
